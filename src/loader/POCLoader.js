...
function lasLazAttributes(fMno){
	...
	// Add support for LAS 1.3 specific attributes
	if (fMno.version && new Version(fMno.version).equalOrHigher('1.3')) {
		attributes.add(new PointAttribute("wave-packet", PointAttributeTypes.DATA_TYPE_UINT8, 1));
	}
